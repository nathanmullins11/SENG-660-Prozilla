...
pkgdatadir = $(datadir)/prozilla
pkglibdir = $(libdir)/prozilla
pkgincludedir = $(includedir)/prozilla
...
INTLLIBS = @INTLLIBS@
MAKEINFO = /home/hades/Downloads/vuln-software/Prozilla-1.3.6/src_Prozilla-1.3.6/missing makeinfo
MSGFMT = @MSGFMT@
PACKAGE = prozilla
POFILES = @POFILES@
USE_NLS = @USE_NLS@
...
EXTRA_DIST =  	ANNOUNCE		CREDITS			FAQ			prozilla.spec		prozrc.sample	
